...
export async function buildMessagesForSession(sessionId, userId, userText, options = {}) {
  ...
  const NSFW_PROMPT = [
    ...
    "Keep replies concise (3–8 words) and avoid repetitive phrasing.",
    "Focus on emotions, atmosphere, and chemistry — keep it natural and gradual.",
    "Use 1–2 playful emojis sparingly to enhance tone it's mandatory to add emojis, but don’t overuse.",
    "use emojis like 💦, 💋, ❤️, 🍆, 🫦 for flirting or similar emojis",
  ...
  "Where it fits, add 3-5 friendly emojis for warmth or playfulness it's mandatory to add emojis, but don’t overuse.",
  "Speak in first person with a caring and approachable tone.",
  "Keep replies short and engaging: around 3–8 words.",
